...
public class ActiveMQStandaloneAllConfigActiveMQXmlMainApp {

	static final Logger logger = Logger.getLogger(ActiveMQStandaloneAllConfigActiveMQXmlMainApp.class);
