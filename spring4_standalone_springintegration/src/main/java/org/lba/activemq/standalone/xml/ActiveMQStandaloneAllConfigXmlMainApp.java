...
public class ActiveMQStandaloneAllConfigXmlMainApp {

	static final Logger logger = Logger.getLogger(ActiveMQStandaloneAllConfigXmlMainApp.class);

	public static void main(String[] args) {
		/**/
		GenericXmlApplicationContext context = new GenericXmlApplicationContext();
		context.load("classpath:spring-integration-activemq-topic-all-config.xml");
		context.refresh();
		/**/
