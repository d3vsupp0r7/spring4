package org.lba.spring4.config.app.controller;

import java.util.ArrayList;
import java.util.List;

import org.apache.log4j.Logger;
import org.lba.spring4.config.data.AppInfoBean;
...
public class AppInfoController {
	...
	public String infoContextBeans(Model model) {
		...
		// http://localhost:8080/spring4_mvc_hello_world_basic_security_oidc_github/infoContextBeans
	...
	public String infoContextBeansByName(@RequestParam String beanName, Model model) {
		//	http://localhost:8080/spring4_mvc_hello_world_basic_security_oidc_github/infoContextBeansByName?beanName=employeeServiceImpl
	...
	public String infoContextBeansByLikeName(@RequestParam String beanName, Model model) {
		//	http://localhost:8080/spring4_mvc_hello_world_basic_security_oidc_github/infoContextBeansByLikeName?beanName=security
