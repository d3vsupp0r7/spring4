...
public class InterfaceFactoryMethod_Example1_SpringFactory_RandomGenerator1_App {

	static final Logger LOGGER = Logger.getLogger(InterfaceFactoryMethod_Example1_SpringFactory_RandomGenerator1_App.class);

	public static void main(String[] args) {

		/*Initialize Spring context*/
		String springContextFileName = "app-context-for-interfaces-spring-factorymethod-example1.xml";
		ApplicationContext context = 
				new ClassPathXmlApplicationContext("classpath:META-INF/spring/interfaces/"+springContextFileName);
		/**/
		InterfaceFactoryMethod_Example1_SpringFactory_RandomGenerator1_App mainApp = context.getBean(InterfaceFactoryMethod_Example1_SpringFactory_RandomGenerator1_App.class);
		mainApp.start(args);
