...
@ComponentScan(basePackages = "org.lba.beans.interfaces.multiimpl.example")
public class InterfaceFactoryMethod_Example1_InvalidOperationHandler_App {

	static final Logger LOGGER = Logger.getLogger(InterfaceFactoryMethod_Example1_InvalidOperationHandler_App.class);

	public static void main(String[] args) {

		/*Initialize Spring context*/
		String springContextFileName = "app-context-for-interfaces-multiimpl-example.xml";
		ApplicationContext context = 
				new ClassPathXmlApplicationContext("classpath:META-INF/spring/interfaces/"+springContextFileName);
		/**/
		InterfaceFactoryMethod_Example1_InvalidOperationHandler_App mainApp = context.getBean(InterfaceFactoryMethod_Example1_InvalidOperationHandler_App.class);
		mainApp.start(args);
