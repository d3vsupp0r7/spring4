...
public class InterfaceFactoryMethod_Example2_ManageOperationHandler_App {

	static final Logger LOGGER = Logger.getLogger(InterfaceFactoryMethod_Example2_ManageOperationHandler_App.class);
	...
	public static void main(String[] args) {
		...
		/**/
		InterfaceFactoryMethod_Example2_ManageOperationHandler_App mainApp = context.getBean(InterfaceFactoryMethod_Example2_ManageOperationHandler_App.class);
		mainApp.start(args);
