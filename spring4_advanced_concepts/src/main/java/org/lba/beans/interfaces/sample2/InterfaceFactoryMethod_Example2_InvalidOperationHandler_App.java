...
public class InterfaceFactoryMethod_Example2_InvalidOperationHandler_App {

	static final Logger LOGGER = Logger.getLogger(InterfaceFactoryMethod_Example2_InvalidOperationHandler_App.class);
	...
	public static void main(String[] args) {
		...
		/**/
		InterfaceFactoryMethod_Example2_InvalidOperationHandler_App mainApp = context.getBean(InterfaceFactoryMethod_Example2_InvalidOperationHandler_App.class);
		mainApp.start(args);
