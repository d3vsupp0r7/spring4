...
public class InterfaceFactoryMethod_GOF_InvalidOperationHandler_App {

	static final Logger LOGGER = Logger.getLogger(InterfaceFactoryMethod_GOF_InvalidOperationHandler_App.class);
	...
	public static void main(String[] args) {
		...
		/**/
		InterfaceFactoryMethod_GOF_InvalidOperationHandler_App mainApp = context.getBean(InterfaceFactoryMethod_GOF_InvalidOperationHandler_App.class);
		mainApp.start(args);
