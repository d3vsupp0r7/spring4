...
<title>SpringMVC - Add Full Employee</title>
</head>
<body>
	<h2>
		<spring:message code="lbl.page" text="Add New Full Employee" />
	</h2>
	<br />
	...
	<form:form method="post" modelAttribute="employee" action="${contextPath}/employee-web/submitAddEmployee">
		<table>
			...
			<tr>
				<td colspan="2"><input type="submit" value="Add Full Employee" /></td>
			</tr>
		</table>
	</form:form>
</body>
