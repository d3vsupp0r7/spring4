...
public class WriterStep2 implements ItemProcessor<List<JobRecordDataTO>, List<JobRecordDataTO>> {

	static final  Logger LOGGER = Logger.getLogger(WriterStep2.class);
