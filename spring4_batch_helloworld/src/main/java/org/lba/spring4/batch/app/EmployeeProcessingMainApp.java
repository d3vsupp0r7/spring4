...
public class EmployeeProcessingMainApp {
    ...
    public static void main(String[] args) {        
    	...
    	contextObj.load("classpath:spring/batch/jobs/employee/spring-beans.xml");
    	contextObj.refresh();
    	
        jobObj = (Job) contextObj.getBean("simpleEmployeeProcessingJob");
