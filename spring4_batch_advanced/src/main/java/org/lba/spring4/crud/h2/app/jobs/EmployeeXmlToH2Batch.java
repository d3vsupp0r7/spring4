...
public class EmployeeXmlToH2Batch {

	static final Logger logger = Logger.getLogger(EmployeeXmlToH2Batch.class);
	...
	public static void main(String[] args) {
		...
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("classpath:/h2-config/batch/jobs/spring-beans-xml2db.xml");
    	
		/*1. Configure job*/
        jobObj = (Job) context.getBean("xml2H2DBJob");
